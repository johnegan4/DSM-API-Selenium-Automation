...
public class OnboardingDocumentation extends LoadDriver {
	...
	@FindBy(how = How.XPATH, using = "/html/body/div[1]/div[2]/div[1]/ul/li[3]/a")
	private static WebElement Reports_Link;
	
	@FindBy(how = How.XPATH, using = "//a[contains(text(),'View Online Documentation')]")
	private static WebElement ViewOnlineDocumentation_link;
	
	
	// Test Onboarding Documentation form
