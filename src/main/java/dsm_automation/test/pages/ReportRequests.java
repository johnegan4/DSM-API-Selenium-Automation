...
public class ReportRequests extends LoadDriver {
	...
	public ReportRequests(WebDriver driver) {
		...
		@FindBy(how = How.XPATH, using = "//select[@id='whichapp']")
		private static WebElement whichapp;
		
		@FindBy(how = How.XPATH, using = "//*[@id='request_id']")
		private static WebElement request_ID;
		
		@FindBy(how = How.XPATH, using = "//input[@id='request_call']")
		private static WebElement request_call;
	
		@FindBy(how = How.XPATH, using = "//input[@id='request_code']")
		private static WebElement request_code;
	
		@FindBy(how = How.XPATH, using = "//*[@id=\"request_response\"]")
...
//			commonpageActions.click(driver, Requests_link , 360);
			...
			commonpageActions.ReportRequests(excelFilePath, sheetName, whichapp, request_ID, request_call, request_code, request_response, start_date, end_date );
